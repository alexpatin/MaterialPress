...
<div class="section no-pad-bot" id="index-banner">
      <div class="container">
        ...
        <div class="row center"><a class="red-text lighten-4" href="https://github.com/Dogfalo/materialize">alpha release v0.69</a></div>
        <br>
      </div>
      <div class="github-commit">
        <div class="container">
          <div class="commit">
            ...
            <a id="github-button" href="https://github.com/Dogfalo/materialize" class="btn-flat right-align grey-text lighten-5 waves-effect waves-light hide-on-med-and-down">Github</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class='section'>
      ...
      <div class='row'>
        <div class='col s12 m4 center promo'>
